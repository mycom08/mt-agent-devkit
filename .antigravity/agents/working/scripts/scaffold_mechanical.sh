...
AGENTS="$TARGET/.antigravity/agents"
...
function cp_sub() {
  local src="$1"
  local dst="$2"
  sed -e 's/{{AGENT_DIR_PREFIX}}/.antigravity/g' \
...
cp_sub "$TPL/skills/read-section/SKILL_template.md" "$TARGET/.antigravity/skills/read-section/SKILL.md"
...
#    See .antigravity/agents/working/skeletons/shared/Version_Release_Conventions.md.
