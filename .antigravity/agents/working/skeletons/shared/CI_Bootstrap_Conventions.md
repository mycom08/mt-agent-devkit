...
Same convention as the Java skeleton shapes, reused verbatim — agent memory commits (`.antigravity/agents/memory/`), README/docs edits, and other non-code changes must not burn CI runs:
