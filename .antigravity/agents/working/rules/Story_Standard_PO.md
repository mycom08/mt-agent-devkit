...
> Product Owner working rules for story work. This is your day-to-day reference. `.antigravity/agents/working/rules/Story_Standard.md` remains the full cross-role source for anything not covered here.
