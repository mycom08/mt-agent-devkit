...
| You changed runtime state this session | `Agent_Common_Read_On_Demand.md §5` (Runtime-State Handoff) — **read-section** skill on `.antigravity/agents/working/rules/Agent_Common_Read_On_Demand.md` §5 |
