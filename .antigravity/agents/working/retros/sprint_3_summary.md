...
### Actions Applied
- `.antigravity/agents/working/context/Project_Priming.md` §15 — added dual-update carve-outs: intentionally-diverged mirror (document, don't force-match) and absent mirror (note absence, don't create) [devkit-internal, no version bump]
