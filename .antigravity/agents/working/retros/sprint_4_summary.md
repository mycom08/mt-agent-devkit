...
### Actions Applied
- `.antigravity/agents/working/context/Project_Priming.md` — added §15a: "Adding a New Agent Role (Nth Role)" checklist covering every enumeration point + the working-record mirror carve-out.
