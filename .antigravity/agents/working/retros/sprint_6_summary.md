...
- `[instruction]` AC phrase "added to the trigger table" was ambiguous about which of `AGENTS.md`'s three candidate tables — resolved by precedent-matching sibling commands, no story-blocking question needed. *(Developer)*
