...
### Fact 8
- **Rule:** For additive-only PRs (scripts/docs/CI only), the regression check is confirming `git diff main..HEAD --name-only` contains nothing under `.antigravity/agents/templates/` or `.antigravity/agents/workflows/`.
