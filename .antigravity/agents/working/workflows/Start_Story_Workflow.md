...
- **Retro Review** — after Stage 5 (or immediately after Stage 4 if Stage 5 is disabled):
  1. Read `.antigravity/agents/working/retros/ST-XXXXXX_retro.md`
  ...
  4. Read `Sprint` from the state file; append a story section to `.antigravity/agents/working/retros/sprint_N_summary.md` (see Sprint_Workflow.md for format; create the file if it does not exist)
  5. Delete `.antigravity/agents/working/retros/ST-XXXXXX_retro.md`
