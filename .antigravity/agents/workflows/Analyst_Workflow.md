...
The orchestrator maintains `.antigravity/agents/tmp/analyst_workflow_state.md` to support resumption after unexpected termination.
...
1. Orchestrator reads `.antigravity/agents/business_analyst_instructions.md` to internalise the BA questioning approach and domain knowledge
