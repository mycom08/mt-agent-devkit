...
- **10 of 20 rules files verbatim** (`{github-org}/{repo-name}` substituted, nothing else): `Agent_Common`, `Audit_Rules`, `Blocked_Request`, `CICD_Validation_Guide`, `Clean_Code_Rules`, `Product_Owner_Rules`, `Retro_Rules`, `Story_Standard_TL`, `Strict_Mode_Story_Guide`, `UI_Prototype_Rules`
