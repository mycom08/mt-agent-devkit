...
| Working Record | `.antigravity/agents/working-record/Business_Analyst_Working_Record.md` |
| Rules | `.antigravity/agents/rules/Business_Analyst_Rules.md` |
| Memory | `.antigravity/agents/memory/Business_Analyst_Memory.md` |
