...
**Strict mode:** Stories are **local MD files** under `.antigravity/agents/docs/stories/` (filename: `ST-XXXXXX.md`). No GitHub Issues are created. See `Strict_Mode_Story_Guide.md` for the full format and lifecycle.
...
For the full workflow (status transitions, role boundaries, AC rules, merge gate, comment format): `.antigravity/agents/rules/Story_Standard.md`
