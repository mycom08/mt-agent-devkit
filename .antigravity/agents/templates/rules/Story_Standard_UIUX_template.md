...
> UI/UX Designer working rules for story work. This is your day-to-day reference. `.antigravity/agents/rules/Story_Standard.md` remains the full cross-role source for anything not covered here.
