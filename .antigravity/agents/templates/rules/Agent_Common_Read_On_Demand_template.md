...
**Retrieval:** bounded read only, never a full-file read of the archive — locate the fact by grepping the heading marker `^### Fact ` instead of reading the whole file.
