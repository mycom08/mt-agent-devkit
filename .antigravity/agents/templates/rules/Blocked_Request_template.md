...
2. Write the filled-in comment to `.antigravity/agents/tmp/blocked_<story-id>.md`
3. Post it: `gh issue comment <number> --repo {github-org}/{repo-name} --body-file .antigravity/agents/tmp/blocked_<story-id>.md`
