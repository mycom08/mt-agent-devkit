...
**Reference from:** `.antigravity/agents/business_analyst_instructions.md`
...
2. **Read your Working Record** — `.antigravity/agents/working-record/Business_Analyst_Working_Record.md`
