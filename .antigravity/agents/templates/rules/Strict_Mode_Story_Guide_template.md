...
Reference for all agents operating in `mode: strict`. Replaces all GitHub Issues, GitHub PR, and GitHub Actions operations with local equivalents. All files live under `.antigravity/agents/` and are gitignored — no agent files are ever committed to the project.
...
```
.antigravity/agents/docs/stories/ST-XXXXXX.md
```
...
1. Read `.antigravity/agents/docs/story_counter.txt` — contains the last used integer (e.g., `3`)
...
5. Create the story file: `.antigravity/agents/docs/stories/ST-000004.md`
...
**Location:** `.antigravity/agents/docs/reviews/ST-XXXXXX_review.md`
...
| `gh issue view <n>` | Read `.antigravity/agents/docs/stories/ST-XXXXXX.md` |
...
| `git add .antigravity/agents/...` | **Never do this** — entire `.antigravity/agents/` is gitignored |
