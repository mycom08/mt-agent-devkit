...
On any tooling/environment blocker (prototype won't start, mock backend won't run, script/CLI errors), follow the check-memory → fix → record-to-memory protocol in `.antigravity/agents/rules/Agent_Common.md §3`.
