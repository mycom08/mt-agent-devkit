...
| What | Where |
|---|---|
| Project overview and architecture | `.antigravity/agents/context/Project_Priming.md` |
| All workflow trigger mappings | `CLAUDE.md` §Workflows |
| Agent roles and instruction files | `CLAUDE.md` §Agent Roster |
| Strict-mode story format and operations | `.antigravity/agents/rules/Strict_Mode_Story_Guide.md` |
| CI/CD story validation (github mode only) | `.antigravity/agents/rules/CICD_Validation_Guide.md` |
