...
|---|---|
| `CLAUDE.md` | `.antigravity/agents/templates/Project_CLAUDE_template.md` |
| `.antigravity/agents/context/Project_Priming.md` | `.antigravity/agents/templates/context/Project_Orchestrator_Priming_template.md` |
| `.antigravity/agents/workflows/Build_Software_Project_Workflow.md` | `.antigravity/agents/templates/workflows/Build_Software_Project_Workflow_template.md` |
| `.antigravity/agents/workflows/Sync_Devkit_Project_Workflow.md` (this file) | `.antigravity/agents/templates/workflows/Sync_Devkit_Project_Workflow_template.md` |
...
**Source:** `{DEVKIT_SOURCE_URL}/.antigravity/agents/templates/Project_CLAUDE_template.md`
...
**Source:** `{DEVKIT_SOURCE_URL}/.antigravity/agents/templates/workflows/Build_Software_Project_Workflow_template.md`
...
**Source:** `{DEVKIT_SOURCE_URL}/.antigravity/agents/templates/workflows/Sync_Devkit_Project_Workflow_template.md`
