...
For Developer, QA, and Technical Lead — two-tier memory (`Agent_Common.md §12`):
...
3. Leave `## Troubleshooting Facts` as-is (unchanged from the single-file case — it lives in the live file for these roles too, see §12).
