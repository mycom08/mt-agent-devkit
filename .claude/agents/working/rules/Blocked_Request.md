...
2. Write the filled-in comment to `.claude/agents/working/tmp/blocked_<story-id>.md`
3. Post it: `gh issue comment <number> --repo mycom08/mt-agent-devkit --body-file .claude/agents/working/tmp/blocked_<story-id>.md`
