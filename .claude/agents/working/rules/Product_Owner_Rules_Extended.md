...
6. Write your retrospective section to `.claude/agents/working/retros/ST-XXXXXX_retro.md` — read `.claude/agents/working/rules/Agent_Common_Records.md §3` for format; overwrite the `## Product Owner` section only
