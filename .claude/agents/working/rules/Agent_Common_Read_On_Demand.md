...
Memory, Working Records, retrospectives, telemetry, and pipeline state are local runtime state. Never `git add`, commit, or push them on a product branch; report stage completion after the local handoff.
