...
| Command | When to use |
|---|---|
| `create stories` | You have requirements and want Claude to draft stories — saved as GitHub Issues |
...
Step 1 — create stories
         ...
         they are saved to the backlog as GitHub Issues.
...
| All workflow trigger mappings | `.claude/agents/working/instructions/orchestrator_instructions.md` §Sprint Workflows (Devkit) |
