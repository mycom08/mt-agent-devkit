...
| What | Path |
|---|---|
| Sprint Retro Summaries | `.claude/agents/working/retros/ST-XXXXXX_retro.md` |
| Agent Instructions | `.claude/agents/working/instructions/` |
| Agent Rules | `.claude/agents/working/rules/` |
| Agent Memory | `.claude/agents/working/memory/` |
| Agent Working Records | `.claude/agents/working/working-record/` |
| Devkit Templates | `.claude/agents/templates/` |
| Devkit Workflows | `.claude/agents/workflows/` |
| Sprint Workflows | `.claude/agents/working/workflows/` |
