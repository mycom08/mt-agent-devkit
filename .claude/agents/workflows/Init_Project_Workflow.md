...
|---|---|---|
| `templates/{mode}/Repo_Root_template.md` (shared content from `templates/shared/Repo_Root_Shared_template.md`) | `CLAUDE.md` (root) | Adaptive |
| `templates/{mode}/Orchestrator_Instructions_template.md` (shared content from `templates/shared/Orchestrator_Instructions_Shared_template.md`) | `.claude/agents/orchestrator_instructions.md` | Mechanical |
