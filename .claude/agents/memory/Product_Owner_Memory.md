...
- **Source:** `.claude/agents/context/PROJECT_PRIMING.md` section 4.2 API Spec Standard; `docs/feature/Attribute_Based_Access_Control-ABAC/stories/D1_ABAC_Policy_API_Contract.md`
...
### Fact 4
- **Fact:** The roadmap's Phase 2 Sprint 5 story IDs are shifted by one due to ST-000024 being used for the CI/CD (Docker image) story rather than the Casbin Evaluator. Correct renumbering: ST-000025 = Casbin ABAC Evaluator (was roadmap ST-000024), ST-000026 = Advanced Operators (was ST-000025), ST-000027 = External Attribute Sources (was ST-000026), ST-000028 = Redis Distributed Cache (was ST-000027), ST-000029 = Admin UI Readiness (was ST-000028).
- **Source:** GitHub issue list cross-check 2026-05-18; Issue #74 = ST-000024 CI/CD story.
- **Reason:** Prevents future story ID collisions; ensures correct ID assignment when creating Sprint 5 GitHub Issues.
...
- **Source:** `.claude/agents/rules/STORY_STANDARD.md` §15 (added 2026-05-13); discovered during ST-000020 Issue #65 AC body edit.
