...
- [ST-000144] Ignored `.antigravity/` runtime files (working records, tmp, token traces) on the same terms as their `.claude/` counterparts, and untracked the 12 files already committed.
